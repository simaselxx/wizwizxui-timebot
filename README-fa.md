...
```
bash <(curl -s https://raw.githubusercontent.com/simaselxx/wizwizxui-timebot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/simaselxx/wizwizxui-timebot/main/update.sh)
```
